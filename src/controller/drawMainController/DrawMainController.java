    ...
    public void mouseDragged(MousePoint p) {
        switch(drawMain.getDrawMode()) {
            ...
            case RECTANGEL:{    // 绘制矩形
                ...
                BufferedImage image = rectangleController.draw(drawMain.getPressedImage());  // 绘制矩形到图像上
                drawMain.setImage(image);   // 更新绘制图像
            }break;
            case CIRCLE:{   // 绘制圆形
            ...
            case ROSE:{ // 画玫瑰
                RoseDraw roseController=new RoseDraw(drawMain.getPressedPoint(),  p, drawMain.getPenColor());
